							...
							<div class="checkbox-wrapper col-12 form-group mt-3 rounded">
								<div class="row position-relative">
									...
									<div class="col-3 checkbox-holder d-none">
										...
										<div class="form-check form-check-inline ml-2">
											<input class="form-check-input" type="checkbox" name="genre[]" id="checkbox5" value="Classics">
			  								<label class="form-check-label" for="checkbox5">Classics</label>
										</div>
										<div class="form-check form-check-inline ml-2">
									...
									<div class="col-3 checkbox-holder d-none">
										<div class="form-check form-check-inline ml-2">
											<input class="form-check-input" type="checkbox" name="genre[]" id="checkbox7" value="Memoir">
			  								<label class="form-check-label" for="checkbox7">Memoir</label>
										</div>
										<div class="form-check form-check-inline ml-2">
									...
									<div class="col-3 checkbox-holder d-none">
										<div class="form-check form-check-inline ml-2">
											<input class="form-check-input" type="checkbox" name="genre[]" id="checkbox10" value="Poetry">
			  								<label class="form-check-label" for="checkbox10">Poetry</label>
										</div>
										<div class="form-check form-check-inline ml-2">
											<input class="form-check-input" type="checkbox" name="genre[]" id="checkbox11" value="Travel">
			  								<label class="form-check-label" for="checkbox11">Travel</label>
										</div>
										<div class="form-check form-check-inline ml-2">
