...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 14, 2018 at 10:08 PM
...
(12, 'The Outsider', 'An eleven-year-old boy is found in a town park, hideously assaulted and murdered. The fingerprints (and later DNA) are unmistakably those of the townâ€™s most popular baseball coach, Terry Maitland, a man of impeccable reputation.', 'Horror, Thriller, Mystery', '270.00', 4, 4, 'yes'),
(13, 'Wyrd Sisters', 'Kingdoms wobble, crowns topple and knives flash on the magical Discworld as the statutory three witches meddle in royal politics. The wyrd sisters battle against frightful odds to put the rightful king on the throne.', 'Comedy, Fantasy', '190.00', 3, 3, 'yes'),
(14, 'Everything We Keep', 'A luminous debut with unexpected twists, Everything We Keep explores the devastation of loss, the euphoria of finding love again, and the pulse-racing repercussions of discovering the truth about the ones we hold dear and the lengths they will go to protect us.', ' Fantasy, Mystery,\r\nRomance', '150.00', 3, 3, 'yes'),
(15, 'The Kite Runner', 'Amir is the son of a wealthy Kabul merchant, a member of the ruling caste of Pashtuns. Hassan, his servant and constant companion, is a Hazara, a despised and impoverished caste.', 'Classics', '200.00', 4, 4, 'yes'),
...
(17, 'The Hobbit', 'In a hole in the ground there lived a hobbit. Not a nasty, dirty, wet hole, filled with the ends of worms and an oozy smell, nor yet a dry, bare, sandy hole with nothing in it to sit down on or to eat: it was a hobbit-hole, and that means comfort.', 'Fantasy, Classics', '199.99', 5, 5, 'yes'),
...
ALTER TABLE `rentals_books`
  ADD CONSTRAINT `fk_rentals_films_films` FOREIGN KEY (`id_book`) REFERENCES `books` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
