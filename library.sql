...
CREATE TABLE `books` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_books_writers_idx` (`writer_id`),
  CONSTRAINT `fk_books_writers` FOREIGN KEY (`writer_id`) REFERENCES `writers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `books_genres` VALUES (5,2,9),(6,2,1),(7,2,33),(8,3,1),(9,3,18),(10,4,1),(11,4,31),(12,4,35),(13,5,30),(14,5,1),(18,7,1),(19,7,15),(20,7,25),(21,8,37),(22,8,9),(23,9,1),(24,9,11),(25,10,1),(26,10,9),(27,10,26),(31,12,12),(32,12,15),(33,12,10),(34,13,9),(35,13,2),(36,14,10),(37,14,15),(38,14,21),(39,15,10),(40,15,11),(41,16,23),(42,16,40),(43,17,9),(44,17,1),(45,17,33),(46,21,13),(47,21,12),(48,21,30),(49,22,23),(50,23,1),(51,23,39),(52,23,21),(62,29,1),(63,29,11),(64,29,30),(161,6,10),(162,6,15),(163,6,25),(176,28,1),(177,28,21),(190,11,1),(191,11,27),(192,11,39),(196,1,1),(197,1,31),(198,1,30);
...
INSERT INTO `writers` VALUES (1,'J.','R. R. Tolkien','yes'),(2,'Pearl S.','Buck','yes'),(3,'Khaled','Hosseini','yes'),(5,'Agatha','Christie','yes'),(6,'Terry','Pratchett','yes'),(10,'Aleksandar','Tešić','yes'),(11,'Stevan','Jakovljević','yes'),(12,'S.J.','Watson','yes'),(13,'George Gordon','Byron','yes'),(14,'Dragoslav','Mihailović','yes'),(15,'Jules','Verne','yes'),(16,'Stephen','King','yes'),(17,'Kerry','Lonsdale','yes'),(18,'Lois','McMaster Bujold','yes'),(19,'Joseph','Joffre','yes'),(20,'Cherie','Priest','yes'),(21,'William','Shakespeare','yes'),(22,'Leo','Tolstoy','yes'),(23,'Erich','Maria Remarque','yes'),(25,'Ivo','Andrić','yes'),(26,'Branko','Ćopić','yes'),(27,'Jovan','Jovanović Zmaj','yes');
...
-- Dump completed on 2018-07-20 10:21:25
